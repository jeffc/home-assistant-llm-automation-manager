...
*   **Intents**: Custom intents (`CreateAutomation`, `DeleteAutomation`, `CreateScript`, `DeleteScript`, `GetExposedNotifyEntities`) are registered in [intent.py](file:///home/jeff/code/ai-generated-tools/home-assistant-meta/custom_components/automation_script_manager/intent.py).
