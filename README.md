...
*   **LLM Tool Integration**: Automatically registers custom intents (`CreateAutomation`, `DeleteAutomation`, `CreateScript`, `DeleteScript`, `GetExposedNotifyEntities`) that expose these actions as tools to LLM integrations (like Assist, Google Generative AI, or OpenAI Conversation).
